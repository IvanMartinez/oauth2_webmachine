...
bad_request_tests(_Config)->
    ...
    Result3 = test_util:request(?AUTHORIZATION_TOKEN_URL, get, 
                                [{"response_type", "token"},
                                 {"redirect_uri", ?CLIENT1_URI}]),
    Result4 = test_util:request(?AUTHORIZATION_TOKEN_URL, get, 
                                [{"response_type", "token"},
                                 {"client_id", ?CLIENT1_ID}]),
    ...
    Result8 = test_util:request(?AUTHORIZATION_TOKEN_URL, post, 
                                [{"response_type", "token"},
                                 ...
                                 {"username", ?USER1_USERNAME},
                                 {"password", ?USER1_PASSWORD}]),
    Result9 = test_util:request(?AUTHORIZATION_TOKEN_URL, post, 
                                [{"response_type", "token"},
                                 {"client_id", ?CLIENT1_ID},
                                 {"redirect_uri", ?CLIENT1_URI},
                                 {"password", ?USER1_PASSWORD}]),
    Result10 = test_util:request(?AUTHORIZATION_TOKEN_URL, post, 
                                [{"response_type", "token"},
                                 {"client_id", ?CLIENT1_ID},
                                 {"redirect_uri", ?CLIENT1_URI},
                                 {"username", ?USER1_USERNAME}]),
